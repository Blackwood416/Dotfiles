 ...
 */
static char *font = "FiraCodeNerdFontMono:pixelsize=26:antialias=true:autohint=false";
 ...
 */
static const char *bgfile = "/path/to/background/file"; // Background file must be a .ff file, check out
                                                        // https://tools.suckless.org/farbfeld to get more information.
...
static const char *colorname[] = {
    ...
    */
    ...
    "#9ece6a", "#e0af68", "#7aa2f7", "#bb9af7", "#7dcfff", "#c0caf5", [255] = 0,

    /* more colors can be added after 255 to use with DefaultXX */
    "#c0caf5", "#c0caf5", "#c0caf5", /* default foreground colour */
